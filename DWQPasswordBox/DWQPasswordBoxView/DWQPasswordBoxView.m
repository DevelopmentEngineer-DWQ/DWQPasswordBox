...
//密码风格 圆点半径
#define RADIUS 5
@interface DWQPasswordBoxView () <UITextFieldDelegate>
{
...
@implementation DWQPasswordBoxView
...
- (void)drawRect:(CGRect)rect {
    // Drawing code
    switch (_BoxViewType) {
        case DWQPasswordBoxViewTypeCustom:
        {
            //画字
            //字的起点
            ...
            break;
        case DWQPasswordBoxViewTypeSecret:
        {
            //画圆
            CGContextRef context = UIGraphicsGetCurrentContext();
            for (NSInteger i = 0; i < textArray.count; i ++) {
